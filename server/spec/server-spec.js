...
describe('Persistent Node Chat Server', function() {
  ...
  it('Should output all messages from the DB', function(done) {
    // Let's insert a message into the db
       var queryString = 'INSERT INTO messages (message_text, roomname, user_id) VALUES("Men like you can never change!","main",(SELECT user_id FROM users WHERE username="Valjean"))';
       var queryArgs = [];
